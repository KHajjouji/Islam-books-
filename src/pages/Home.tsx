    ...
    <>
      ...
      <section className="relative bg-emerald-900 text-white overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32 relative z-10">
          <div className="max-w-3xl">
            ...
            <p className="text-lg md:text-xl text-emerald-50 mb-4 font-medium">
            ...
            <p className="text-base md:text-lg text-emerald-100 mb-10">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Link to="/academy" className="inline-flex justify-center items-center px-8 py-4 bg-emerald-800 text-white font-bold rounded-full hover:bg-emerald-700 border border-emerald-600 transition-colors text-lg">
                Explore the Academy
              </Link>
            </div>
            <p className="mt-8 text-sm text-emerald-200/80 flex items-center gap-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <Link key={idx} to={card.link} className="group block h-full">
                <div className="bg-white rounded-2xl p-8 shadow-sm hover:shadow-md transition-shadow border border-stone-100 h-full flex flex-col">
                  <div className={`w-12 h-12 rounded-xl flex items-center justify-center mb-6 ${card.color}`}>
                    <card.icon className="h-6 w-6" />
                  </div>
                  <h3 className="text-xl font-bold text-stone-900 mb-3 group-hover:text-emerald-700 transition-colors">{card.title}</h3>
                  <p className="text-stone-600 flex-grow">{card.text}</p>
      ...
      <section className="py-20 bg-white overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 text-center">
            <Link to="/islamic-childrens-books" className="text-emerald-700 font-bold hover:text-emerald-800 flex items-center justify-center">
      ...
      <section className="py-20 bg-emerald-900 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="space-y-6 text-lg text-emerald-50/90 leading-relaxed">
            <p>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-indigo-50 rounded-3xl p-8 md:p-16 text-center">
            <h2 className="text-3xl md:text-4xl font-serif font-bold text-indigo-950 mb-6">
              Interactive Islamic Learning Beyond the Book
            </h2>
            <p className="text-lg text-indigo-900/80 mb-8 max-w-3xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 max-w-4xl mx-auto mb-10 text-left">
              {[
                ...
                <div key={i} className="bg-white p-4 rounded-xl shadow-sm flex items-start">
                  <Sparkles className="h-5 w-5 text-indigo-500 mr-3 flex-shrink-0 mt-0.5" />
                  <span className="text-indigo-950 font-medium">{item}</span>
                </div>
              ))}
            </div>
            <p className="text-indigo-900/80 mb-8 max-w-2xl mx-auto">
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <form className="flex flex-col sm:flex-row gap-4 max-w-lg mx-auto" onSubmit={(e) => e.preventDefault()}>
            <input 
              ...
              className="flex-grow px-6 py-4 rounded-full border border-stone-300 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent text-lg"
              required
            />
            <button type="submit" className="px-8 py-4 bg-emerald-800 text-white font-bold rounded-full hover:bg-emerald-700 transition-colors text-lg whitespace-nowrap">
      ...
      <section className="py-24 bg-white text-center">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link to="/academy" className="inline-flex justify-center items-center px-8 py-4 bg-stone-100 text-stone-900 font-bold rounded-full hover:bg-stone-200 transition-colors text-lg">
              Join the Academy
            </Link>
          </div>
        </div>
