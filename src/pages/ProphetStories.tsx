    ...
    <>
      ...
      <div className="bg-emerald-50 py-16 md:py-24">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <Star className="h-12 w-12 text-emerald-600 mx-auto mb-6" />
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            {[
              ...
              <div key={i} className="bg-stone-800 p-6 rounded-xl flex items-center justify-between border border-stone-700">
                <span className="text-lg font-medium text-emerald-400">{item.prophet}</span>
                <span className="text-stone-300 bg-stone-700 px-3 py-1 rounded-full text-sm">{item.value}</span>
              </div>
            ))}
          </div>
        </div>
