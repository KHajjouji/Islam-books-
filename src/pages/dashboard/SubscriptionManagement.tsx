  ...
  return (
    <div className="space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div>
        ...
        <p className="text-primary/60 font-medium">Manage your family's access to the Noor & Nurture ecosystem.</p>
      </div>
        ...
        <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <div className="flex items-center gap-4 pt-4">
              <button className="px-8 py-4 bg-secondary text-primary rounded-full font-bold text-sm shadow-xl shadow-black/10 hover:scale-105 transition-all">
                Change Plan
              </button>
        ...
        <div className="bg-surface border border-outline-variant/10 rounded-3xl p-8 shadow-sm">
          <div className="flex items-center gap-4 mb-8">
            ...
            <div>
              ...
              <p className="text-xs text-primary/40 font-medium uppercase tracking-widest">Visa ending in 4242</p>
            </div>
          </div>
          <div className="flex justify-between items-center p-4 bg-surface-container-low rounded-2xl border border-outline-variant/5">
            <div className="flex items-center gap-3">
              <div className="w-10 h-6 bg-secondary rounded-md flex items-center justify-center text-[8px] text-primary font-bold">VISA</div>
              <span className="text-sm font-bold text-primary">Expires 08/2028</span>
            </div>
        ...
        <div className="bg-surface border border-outline-variant/10 rounded-3xl p-8 shadow-sm">
          <div className="flex items-center gap-4 mb-8">
            ...
            <div>
              ...
              <p className="text-xs text-primary/40 font-medium uppercase tracking-widest">Automatic Renewal</p>
            </div>
          </div>
          <div className="flex justify-between items-center p-4 bg-surface-container-low rounded-2xl border border-outline-variant/5">
            <div className="flex items-center gap-3">
              <span className="text-sm font-bold text-primary">{currentPlan.nextBilling}</span>
            </div>
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {otherPlans.map((plan) => (
            <div key={plan.name} className={`bg-surface border rounded-[2.5rem] p-8 shadow-sm relative overflow-hidden flex flex-col justify-between ${plan.popular ? 'border-primary ring-1 ring-primary' : 'border-outline-variant/10'}`}>
              {plan.popular && (
              ...
              <div className="space-y-4">
                ...
                <ul className="space-y-3 pt-4">
                  {plan.features.map((f, i) => (
                    <li key={i} className="flex items-center gap-2 text-sm font-medium text-primary/60">
              ...
              <button className={`mt-8 w-full py-4 rounded-full font-bold text-sm transition-all flex items-center justify-center gap-2 ${plan.popular ? 'bg-primary text-white shadow-lg shadow-primary/10 hover:scale-[1.02]' : 'bg-surface-container-low text-primary border border-outline-variant/10 hover:bg-primary/5'}`}>
