        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white rounded-3xl shadow-sm border border-noor-light-green overflow-hidden">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-0">
              {/* Image Section */}
              <div className="bg-noor-light-green p-8 md:p-16 flex items-center justify-center">
                <img 
                  src={product.image} 
                  alt={product.title} 
              ...
              <div className="p-8 md:p-12 lg:p-16 flex flex-col justify-center">
                ...
                <h1 className="text-3xl md:text-4xl font-serif font-bold text-noor-dark mb-4">
                  {product.title}
                </h1>
                ...
                <div className="text-3xl font-bold text-noor-dark mb-8">
                ...
                {product.ageRange && (
                  <div className="mb-8 p-4 bg-noor-cream rounded-xl border border-noor-light-green inline-block">
                    <span className="text-sm text-noor-dark/60 block mb-1">Recommended Age</span>
                    <span className="font-medium text-noor-dark">{product.ageRange}</span>
                  </div>
                )}

                <div className="flex flex-col sm:flex-row gap-4 mt-auto">
                  <div className="flex items-center border border-noor-light-green/80 rounded-full bg-white px-4 py-2 w-full sm:w-auto justify-between">
                    <button 
                      onClick={() => setQuantity(Math.max(1, quantity - 1))}
                      className="text-noor-dark/60 hover:text-noor-dark px-2 text-xl"
                    >-</button>
                  ...
                  <button 
                    ...
                    className={`flex-grow flex items-center justify-center px-8 py-4 rounded-full font-bold transition-all ${
                      added 
                        ...
                        : 'bg-noor-green text-white hover:bg-noor-green'
                    }`}
                  >
                    {added ? (
                      <>
